...
class MainActivity : AppCompatActivity() {
    ...
    var createInitialThread: CreateInitialThread? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val permissionsList = arrayOf(Manifest.permission.BLUETOOTH, Manifest.permission.BLUETOOTH_ADMIN)
        ...
        if (deviceName != null) {
            ...
            createInitialThread = CreateInitialThread(bluetoothAdapter, deviceAddress, this)
            createInitialThread!!.start()
        }
    }
